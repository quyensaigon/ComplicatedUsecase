...
@WebServlet("/mongoattach")
@MultipartConfig()
public class MongoAttachServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MongoResourceServlet servlet = new MongoResourceServlet();
	...
	*/
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
        	MongoCollection<Document> collection = MongoClientMgr.getDB().getCollection("profiles");
    		...
    		org.bson.types.Binary bin = (org.bson.types.Binary)obj.get("photo"); 
	...
	public void updateUidNumber(String uidNumber)
	{
		...
		try
		{
			...
			*/
			...
			//BasicDBObject searchQuery = new BasicDBObject().append("_id", "ldapautoindex@gmail.com");
			//BasicDBObject newDocument = new BasicDBObject();
			long newUid = Long.parseLong(uidNumber); 
			newUid = newUid +1;
			//newDocument.put("zip", ""+newUid);
			//collection.findOneAndUpdate(searchQuery,newDocument);
			collection.updateOne(new Document("_id", "ldapautoindex@gmail.com"), new Document("$set", new Document("zip",""+newUid)));
