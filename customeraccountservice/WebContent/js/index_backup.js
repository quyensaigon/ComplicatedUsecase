...
function createProfile()
{
	...
	String firstName =  $("#firstname").val();
	String lastName =  $("#lastname").val();
	String address =  $("#address").val();
	String city =  $("#city").val();
	String state =  $("#state").val();
	String zip =  $("#zip").val();
	String homePhone =  $("#homephone").val();
	String workPhone =  $("#workphone").val();
	String mobilePhone =  $("#mobilephone").val();
	String email =  $("#email").val();
	String gender =  $("#gender").val();
	String birthDate =  $("#birthdate").val();
